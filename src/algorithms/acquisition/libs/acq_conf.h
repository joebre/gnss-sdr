...
public:
    ...
    // exit never gets the chance to compare against. Opt-in (new, still-experimental
    // feature): off by default, enable per-implementation in the .conf (e.g.
    // Acquisition_1C.full_grid_search = true).
